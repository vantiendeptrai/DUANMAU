    ...
    <div class="table w-full p-2">
        <table class="w-full border">
            ...
            foreach ($listdanhmuc as $danhmuc) {
                ...
                <td>
                    <a href="'.$suadm.'" class="bg-blue-500 p-2 text-white hover:shadow-lg text-xs font-thin">Sửa</a>
                    <a href="'.$xoadm.'" class="bg-red-500 p-2 text-white hover:shadow-lg text-xs font-thin">Xóa</a>
                </td>
            </tr>';
            }
            ?>
